...
/// <inheritdoc/>
        ...
        protected override void DataConvert(string binary)
        {
            try
            {
                ...
                //DistLongRms = (SignalValueEnum)Convert.ToByte(binary.Substring(8, 5), 2);
                //DistLatRms = (SignalValueEnum)Convert.ToByte(binary.Substring(13, 5), 2);
                //VrelLongRms = (SignalValueEnum)Convert.ToByte(binary.Substring(18, 5), 2);
                //VrelLatRms = (SignalValueEnum)Convert.ToByte(binary.Substring(23, 5), 2);
