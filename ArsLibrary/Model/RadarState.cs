    ...
    public class RadarState : SensorMessage
    {
        ...
        protected override void DataConvert(string binary)
        {
            try
            {
                ...
                Interference = Convert.ToByte(binary.Substring(19, 1), 2);
                TemperatureError = Convert.ToByte(binary.Substring(20, 1), 2);
                TemporaryError = Convert.ToByte(binary.Substring(21, 1), 2);
                VoltageError = Convert.ToByte(binary.Substring(22, 1), 2);
                RadarPower = Convert.ToByte(binary.Substring(30, 3), 2);
                SortIndex = Convert.ToByte(binary.Substring(33, 3), 2);
                SensorId = Convert.ToByte(binary.Substring(37, 3), 2);
                MotionRxState = Convert.ToByte(binary.Substring(40, 2), 2);
                SendExtendedInfo = Convert.ToByte(binary.Substring(42, 1), 2);
                SendQuality = Convert.ToByte(binary.Substring(43, 1), 2);
                OutputType = Convert.ToByte(binary.Substring(44, 2), 2);
                ControlRelay = Convert.ToByte(binary.Substring(46, 1), 2);
