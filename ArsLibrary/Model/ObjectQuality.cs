    ...
    public class ObjectQuality : SensorQuality
    {
        ...
        protected override void DataConvert(string binary)
        {
            try
            {
                ...
                ArelLongRms = (SignalValue)Convert.ToByte(binary.Substring(28, 5), 2);
                ArelLatRms = (SignalValue)Convert.ToByte(binary.Substring(33, 5), 2);
                OrientationRms = (SignalValue_Degree)Convert.ToByte(binary.Substring(38, 5), 2);
